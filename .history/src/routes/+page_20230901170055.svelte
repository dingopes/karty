<script>
	...
	//Import svg ikon
	import beznyKralik from '../assets/beznyKralik.svelte';
	import divnyKralik from '../assets/divnyKralik.svelte';
</script>
